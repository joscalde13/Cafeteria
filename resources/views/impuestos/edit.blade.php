<x-layouts::app :title="__('Editar Impuesto')">
    <div class="mb-6">
        <flux:heading size="xl">{{ __('Editar Impuesto') }}</flux:heading>
    </div>
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div>
                        <label for="nombre"
                            ...
                            *</label>
                        <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $impuesto->nombre) }}"
                            required
                    ...
                    <div>
                        ...
                        <input type="number" name="porcentaje" id="porcentaje"
                            value="{{ old('porcentaje', $impuesto->porcentaje) }}" step="0.01" min="0" max="100"
                            required
                            class="w-full rounded-lg border border-neutral-300 bg-white px-4 py-2 text-sm text-neutral-900 focus:border-blue-500 focus:ring-blue-500 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-100">
                    ...
                    <div>
                        ...
                        <input type="date" name="recordatorio_pago" id="recordatorio_pago"
                            value="{{ old('recordatorio_pago', $impuesto->recordatorio_pago?->format('Y-m-d')) }}"
                            class="w-full rounded-lg border border-neutral-300 bg-white px-4 py-2 text-sm text-neutral-900 focus:border-blue-500 focus:ring-blue-500 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-100">
                    </div>
                    <div class="flex items-end">
                        <label class="flex items-center gap-2">
                            <input type="checkbox" name="activo" value="1" {{ old('activo', $impuesto->activo) ? 'checked' : '' }}
