<x-layouts::app :title="__('Editar Compra')">
    ...
    <div class="mb-10">
        <flux:heading size="xl">{{ __('Editar Compra') }} #{{ $compra->id }}</flux:heading>
    </div>
        ...
        <div class="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            ...
            <form action="{{ route('compras.update', $compra) }}" method="POST">
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        <label for="concepto"
                            ...
                            *</label>
                        <input type="text" name="concepto" id="concepto" value="{{ old('concepto', $compra->concepto) }}" required
                    ...
                    <div>
                        <label for="cantidad"
                            ...
                            *</label>
                        <input type="number" name="cantidad" id="cantidad" value="{{ old('cantidad', $compra->cantidad) }}"
                    ...
                    <div>
                        <label for="precio_unitario"
                            ...
                            *</label>
                        <input type="number" name="precio_unitario" id="precio_unitario" value="{{ old('precio_unitario', $compra->precio_unitario) }}"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="notas" id="notas" rows="3"
                            class="w-full rounded-lg border border-neutral-300 bg-white px-4 py-2 text-sm text-neutral-900 focus:border-cyan-500 focus:ring-cyan-500 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-100">{{ old('notas', $compra->notas) }}</textarea>
                        @error('notas') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                </div>
                ...
                <div class="mt-8 flex items-center gap-4">
                    <button type="submit"
                        class="rounded-xl bg-cyan-600 px-5 py-2 text-sm font-semibold text-white transition hover:bg-cyan-500">Actualizar</button>
