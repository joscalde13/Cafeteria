                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        <label for="total"
                            ...
                            *</label>
                        <input type="number" name="total" id="total" value="{{ old('total', $compra->total) }}"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="notas" id="notas" rows="3"
                            class="w-full rounded-lg border border-neutral-300 bg-white px-4 py-2 text-sm text-neutral-900 focus:border-blue-500 focus:ring-blue-500 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-100">{{ old('notas', $compra->notas) }}</textarea>
                    </div>
                </div>
